...
from . import rgb_as_color_f
from .. import led, vuspectrum, CHANNEL_SPECTRUM_BANDS, CHANNEL_SPECTRUM_MODE
    ...
    if data[CHANNEL_SPECTRUM_MODE] != 6:
        ...
        for x in range(led.WIDTH - 1, 0, -1):
            for y in range(led.HEIGHT):
                ...
                if x == 1:
                    leds.set_led(0, y, rgb_as_color_f(*hsv_to_rgb(4 / 6 - 4 / 6 * levels[y], 1, 1)))
    return True
